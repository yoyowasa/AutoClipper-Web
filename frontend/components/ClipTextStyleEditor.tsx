      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        ...
        <label className="flex flex-col gap-1 text-xs font-semibold text-neutral-700 sm:col-span-2">
          <span className="flex justify-between">
            横位置
            <span className="font-normal tabular-nums">{style.xPercent}%</span>
          </span>
          <input
            ...
            onChange={(event) => updateStyle({ xPercent: Number(event.target.value) })}
          />
        </label>
        ...
        <label className="flex flex-col gap-1 text-xs font-semibold text-neutral-700 sm:col-span-2">
          <span className="flex justify-between">
            縦位置
            <span className="font-normal tabular-nums">{style.yPercent}%</span>
          </span>
          <input
            className="h-6 accent-sky-600"
            disabled={disabled}
            ...
            onChange={(event) => updateStyle({ yPercent: Number(event.target.value) })}
          />
        </label>
      </div>
