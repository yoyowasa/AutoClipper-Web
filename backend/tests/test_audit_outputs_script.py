...
def test_audit_accepts_configurable_japanese_ass_fonts(tmp_path: Path) -> None:
    ...
    path.write_text(
        ...
        "BackColour, Bold, Italic, Underline, StrikeOut, ScaleX, ScaleY, Spacing, Angle, "
        "BorderStyle, Outline, Shadow, Alignment, MarginL, MarginR, MarginV, Encoding\n"
        "Style: Subtitle,Noto Sans Mono CJK JP,68,&H00FFFFFF,&H000000FF,&H00000000,"
        "&H80000000,1,0,0,0,100,100,0,0,1,4,2,5,0,0,0,1\n"
        "Style: Title,Source Han Sans JP Heavy,92,&H00FFFFFF,&H000000FF,&H00000000,"
        "&H80000000,1,0,0,0,100,100,0,0,1,6,2,5,0,0,0,1\n"
        "Style: Hook,Noto Serif CJK JP,76,&H00FFFFFF,&H000000FF,&H00000000,"
